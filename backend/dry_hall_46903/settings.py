"""
Django settings for dry_hall_46903 project.
...
ROOT_URLCONF = 'dry_hall_46903.urls'
...
WSGI_APPLICATION = 'dry_hall_46903.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dry_hall_46903 API",
    "DESCRIPTION": "API documentation for dry_hall_46903 App",
    "VERSION": "v1",
}
